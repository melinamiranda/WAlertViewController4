#
# Be sure to run `pod lib lint WAlertViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'WAlertViewController'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WAlertViewController.'
